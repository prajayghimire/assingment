...
class Test_002__Contact:
    ...
    def test_fillfeilds(self, setup):
        ...
        self.contact_obj.fullName("Lasttime")
        self.contact_obj.companyName("Webo")
        self.contact_obj.emailAddress("suman@gmail.com")
        self.contact_obj.phoneNumber("980431143")
        x = randrange(11)
        self.contact_obj.foundUs(x)
        self.contact_obj.message("Thank you")
